...
![](/images/LeetCode破局攻略/单调队列/title.png)
### 一、搭建解题框架
...
```
![图示](/images/LeetCode破局攻略/单调队列/1.png)
...
![](/images/LeetCode破局攻略/单调队列/2.png)
...
![](/images/LeetCode破局攻略/单调队列/3.png)
...
[上一篇：特殊数据结构：单调栈](/2016/01/01/数据结构系列/单调栈)
[下一篇：设计Twitter](/2016/01/01/数据结构系列/设计Twitter)

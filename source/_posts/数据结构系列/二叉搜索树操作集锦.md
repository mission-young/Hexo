...
通过之前的文章[框架思维](/2016/01/01/算法思维系列/学习数据结构和算法的高效方法)，二叉树的遍历框架应该已经印到你的脑子里了，这篇文章就来实操一下，看看框架思维是怎么灵活运用，秒杀一切二叉树问题的。
...
![BST](images/LeetCode破局攻略/BST/BST_example.png)
...
![notBST](images/LeetCode破局攻略/BST/假BST.png)
...
图片来自 LeetCode
![1](images/LeetCode破局攻略/BST/bst_deletion_case_1.png)
...
图片来自 LeetCode
![2](images/LeetCode破局攻略/BST/bst_deletion_case_2.png)
...
图片来自 LeetCode
![2](images/LeetCode破局攻略/BST/bst_deletion_case_3.png)
...
[上一篇：LRU算法详解](/2016/01/01/高频面试系列/LRU算法)

[下一篇：特殊数据结构：单调栈](/2016/01/01/数据结构系列/单调栈)

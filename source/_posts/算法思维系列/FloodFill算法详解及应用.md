...
![floodfill](images/LeetCode破局攻略/floodfill/floodfill.gif)

这种算法思想还在许多其他地方有应用。比如说扫雷游戏，有时候你点一个方格，会一下子展开一片区域，这个展开过程，就是 FloodFill 算法实现的。

![扫雷](images/LeetCode破局攻略/floodfill/扫雷.png)

类似的，像消消乐这类游戏，相同方块积累到一定数量，就全部消除，也是 FloodFill 算法的功劳。

![xiaoxiaole](images/LeetCode破局攻略/floodfill/xiaoxiaole.jpg)
...
![title](images/LeetCode破局攻略/floodfill/leetcode.png)
...
![ppt1](images/LeetCode破局攻略/floodfill/ppt1.PNG)
...
if (image[x][y] != origColor) return;
```
![ppt2](images/LeetCode破局攻略/floodfill/ppt2.PNG)

但是，如果说 origColor 和 newColor 一样，这个 if 语句就无法让 fill(1, 1)* 正确退出，而是开启了下面的重复递归，形成了死循环。

![ppt3](images/LeetCode破局攻略/floodfill/ppt3.PNG)
...
![抠图](images/LeetCode破局攻略/floodfill/抠图.jpg)
...
![ppt4](images/LeetCode破局攻略/floodfill/ppt4.PNG)
...
![](images/LeetCode破局攻略/floodfill/ppt5.PNG)
...
[上一篇：字符串乘法](/2016/01/01/算法思维系列/字符串乘法)

[下一篇：区间调度之区间合并问题](/2016/01/01/算法思维系列/区间调度问题之区间合并)
